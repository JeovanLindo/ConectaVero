...
import VeroLogo from '@/assets/vero.webp'
...
export default function NavBar() {
  return (
  <header className="sticky top-0 z-50 overflow-hidden flex justify-between font-inter items-center h-16 w-full bg-primaria sm:px-32 px-4" >
    ...
    <div className='flex flex-row items-center gap-16'>
      <a href={'/'} className='flex flex-row items-center w-fit h-fit gap-3'>
          ...
          <img className='h-5' src={VeroLogo} alt="Logo da Vivo para empresas autorizadas" />
      </a>
      <div className='hidden lg:flex flex-row gap-4' >
          <nav className='flex flex-row gap-4 text-white' >
            ...
            <button onClick={()=> scrollToSection('services')} className='hover:cursor-pointer hover:text-[#172E80] transition-all'>Benefícios</button>
    ...
    <Sheet modal={false}>
      ...
      <SheetContent className='h-fit flex bg-primaria outline-none border-none flex-col gap-1'>
        ...
        <SheetHeader className='flex flex-col gap-3'>
          <div>
            <SheetTitle className='text-xl text-gray-50 hover:cursor-pointer hover:translate-x-1 hover:text-gray-200 transition-all'><button onClick={()=> scrollToSection('services')}>Benefícios</button></SheetTitle>
          ...
          <Button className='bg-secundaria' asChild>
    ...
    <button
    className='bg-secundaria px-4 text-slate-100 py-1 rounded-sm rounded-ss-3xl hover:bg-opacity-80 transition-all hidden lg:flex'
    >
