...
import LogoVivoEmpresas from '@/assets/vero.webp'

export default function Footer ({ id }: { id: string }){

  return(
    <>
    <footer id={id} className="bg-primaria text-slate-100 font-inter md:px-32 flex-col flex border-t-2 border-gigaAzul justify-between items-center w-full py-10 px-10 h-fit min-h-44">
      <div className='lg:flex-row flex-col flex gap-12 items-center justify-between w-full' >
        ...
        <div className='flex-col gap-1 flex justify-center items-center'>
            ...
            <div className='flex flex-row justify-center items-center space-x-1'>
              <p className='text-slate-100' >Parceiro autorizado</p>
    ...
    <div className='w-full text-slate-100 bg-primaria border-t-[1px] border-gigaAzul text-gigaAzul h-fit py-1 flex md:flex-row flex-col md:gap-3 gap-1 justify-center items-center'>
